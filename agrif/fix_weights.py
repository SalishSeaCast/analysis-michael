# This is more or less a script version of this notebook:
...
netcdf4_weight = '1_weights-gem2.5-ops.nc'  # Filename for the improved weights file
atmos_grid_name = 'GEM 2.5km Operational'


mtime = datetime.fromtimestamp(os.path.getmtime(met_gem_weight))
history = ('[{}] Created netCDF3 classic dataset with get_weight_nemo.'
            .format(mtime.strftime('%Y-%m-%d %H:%M:%S')))

history += ('\n[{}] Converted to netCDF4 with zlib=True and added CF-1.6 metadata.'
